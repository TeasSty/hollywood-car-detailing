...
Секция «Что можно сделать с авто»: оригинальный SVG-силуэт спортивного седана (пропорции в духе BMW M5 Competition, без логотипов и чужих моделей). Анимация обводки от фар до заднего бампера; точки-зоны ведут к строкам прайса. Лицензия иллюстрации: авторская работа для этого сайта (all rights reserved for the SVG artwork, site UNLICENSED).
